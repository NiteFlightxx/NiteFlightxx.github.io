...
interface BorderGlowProps {
  ...
  glowColor?: string; // "H S L" as "H S L" (e.g. "40 80 80")
...
function parseHSL(hslStr: string) {
  ...
  if (!match) return { h: 188, s: 253, l: 73 }; // fallback
...
const BorderGlow = ({
  ...
  className = "",
  edgeSensitivity = 30,
  glowColor = "76 95 64", // Lime-green high fashion default
